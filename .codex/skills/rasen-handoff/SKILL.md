---
name: rasen-handoff
description: Write a handoff document — probe context usage (rasen agent context), distill decisions / dead ends / eliminated hypotheses / next action to the handoff directory, and record the sessionHandoff pointer so a fresh session or successor worker resumes from the distillate instead of a raw transcript.
license: MIT
